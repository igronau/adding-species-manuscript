...
\author[12,13]{Xin Huang}
\author[14]{Leonardo Nicola Martin Iasi} % lastname Iasi
\author[15]{Jana Obšteter}
\author[16]{Vitor Antonio Corrêa Pavinato} % lastname Pavinato
\author[17,16]{David Peede}
% \author[]{Ekaterina Noskova}
% \author[]{Alice Pearson}
\author[19]{Manolo Perez}
\author[6]{Chris Smith}
\author[20]{Jeff Spence}
% \author[2]{Anastasia Teterina}
\author[21]{Per Unneberg}
\author[22]{Juan Manuel Vasquez}
\author[23]{Ryan Waples}
\author[24]{Anthony Wilder Wohns}
\author[25]{Yan Wong}
\author[26]{Reed Cartwright}
\author[27]{Aaron Ragsdale}
\author[28]{Franz Baumdicker}
\author[29]{Gregor Gorjanc}
\author[30]{Ryan Gutenkunst}
\author[25]{Jerome Kelleher}
\author[6]{Andy Kern}
\author[6,31]{Peter Ralph}
\author[32]{Dan Schrider}
\author[33]{Ilan Gronau}
...
\affil[12]{\small{Department of Evolutionary Anthropology, University of Vienna, Djerassiplatz 1, 1030 Vienna, Austria}}
\affil[13]{\small{Human Evolution and Archaeological Sciences (HEAS), University of Vienna, Austria}}
\affil[14]{\small{Department of Evloutionary Genetics, Max Planck Institute for Evolutionary Anthropology, Leipzig, Germany}}
\affil[15]{\small{Agricultural Institute of Slovenia, Department of Animal Science, Hacquetova ulica 17, Ljubljana, Slovenia}}
\affil[16]{\small{Entomology Dept., CFAES, The Ohio State University, Wooster, Ohio}}
\affil[17]{\small{Department of Ecology and Evolutionary Biology, Brown University, Providence, RI, USA}}
\affil[18]{\small{Center for Computational Molecular Biology, Brown University, Providence, RI, USA}}
\affil[19]{\small{Department of Genetics and Evolution, Federal University of Sao Carlos, Sao Carlos 13565905, Brazil}}
\affil[20]{\small{Department of Genetics, Stanford University School of Medicine, Stanford, CA, 94305}}
\affil[21]{\small{Department of Cell and Molecular Biology, National Bioinformatics Infrastructure Sweden, Science for Life Laboratory, Uppsala University,  Husargatan 3, SE-752 37 Uppsala, Sweden}}
\affil[22]{\small{Department of Integrative Biology, University of California, Berkeley, Berkeley, CA, USA}}
\affil[23]{\small{Department of Biostatistics, University of Washington}}
\affil[24]{\small{Broad Institute of MIT and Harvard, Cambridge, MA 02142, USA}}
\affil[25]{\small{Big Data Institute, Li Ka Shing Centre for Health Information and Discovery, University of Oxford, OX3 7LF, UK}}
\affil[26]{\small{Genomics, Evolution, and Bioinformatics, School of Life Sciences and The Biodesign Institute, Arizona State University, Tempe, Arizona}}
\affil[27]{\small{Integrative Biology, University of Wisconsin-Madison, Madison, Wisconsin}}
\affil[28]{\small{Cluster of Excellence - Controlling Microbes to Fight Infections, Eberhard Karls Universität Tübingen, Tübingen, Baden-Württemberg, Germany}}
\affil[29]{\small{The Roslin Institute and Royal (Dick) School of Veterinary Studies, University of Edinburgh, Edinburgh EH25 9RG, UK}}
\affil[30]{\small{Molcular and Cellular Biology, University of Arizona, Tucson, Arizona 85721}}
\affil[31]{\small{Department of Mathematics, University of Oregon, Eugene OR 97402}}
\affil[32]{\small{School of Medicine - Genetics, University of North Carolina at Chapel Hill}}
\affil[33]{\small{Efi Arazi School of Computer Science, Reichman University, Herzliya, Israel}}
